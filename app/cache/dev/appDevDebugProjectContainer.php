...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Library/WebServer/Documents/Symfony/src/Tiku/QuestionsBundle/Entity')), 'Tiku\\QuestionsBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TikuQuestionsBundle' => 'Tiku\\QuestionsBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Library/WebServer/Documents/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'fda0632382e618ccf9984ce54493b8105');
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Library/WebServer/Documents/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Library/WebServer/Documents/Symfony/app');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Library/WebServer/Documents/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Library/WebServer/Documents/Symfony/src/Tiku/QuestionsBundle/Resources/views', 'TikuQuestions');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('fda0632382e618ccf9984ce54493b8105');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TikuQuestionsBundle' => 'Tiku\\QuestionsBundle\\TikuQuestionsBundle',
            ...
            'locale' => 'en',
            'secret' => 'fda0632382e618ccf9984ce54493b8105',
            'database_path' => NULL,
            ...
            'kernel.secret' => 'fda0632382e618ccf9984ce54493b8105',
            ...
            'swiftmailer.spool.default.memory.path' => '/Library/WebServer/Documents/Symfony/app/cache/dev/swiftmailer/spool/default',
